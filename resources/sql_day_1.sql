...
(id Int, name varchar(20), address varchar(25), dob date, college varchar(25),marks Int, grade varchar(10), dept varchar(20),doj date, salary Int, experience  Int);
...
INSERT INTO Interns(id,name,address,dob,college,marks,grade,dept,doj,salary,experience)
VALUES
(101,'Kunal nikam','Katraj','2006-04-12','NIIT',90,'A','IT','2024-06-11',500000,10);
